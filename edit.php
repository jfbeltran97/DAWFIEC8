<?php 
    ...
    $id = $_GET['id'];
    $_SESSION['previousUrl'] = 'edit.php?id=' . $id;
 ?>
<!DOCTYPE html>
<html lang="en">
  <head>
          ...
          <div class="col-md-9">
            ...
            <div class="panel panel-default">
              ...
              <div class="panel-body">
                <form method="post" action="edit_submit.php?id=<?php 
                  $id = $_GET["id"];
                  echo $id;
                 ?>">
                  <div class="form-group">
                    <label>Page Title</label>
                    <input name="title" required type="text" class="form-control" placeholder="Page Title" value="<?php
                      require 'Noticia.php';
                      
                      $noticia = Noticia::getNew($id);  
                      $title = $noticia->title; 
                      echo $title;
                    ?>">
                  </div>
                  <div class="form-group">
                    <label>Resumen</label>
                    <textarea required name="editorR" class="form-control" placeholder="Resumen">
                      <?php 
                        $brief = $noticia->brief;
                        echo $brief;
                       ?>
                  ...
                  <div class="form-group">
                    ...
                    <textarea required name="editor1" class="form-control" placeholder="Page Body">
                      <?php
                        $date = $noticia->date;
