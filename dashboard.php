<?php 
    ...
    $_SESSION['previousUrl'] = 'dashboard.php';
    $delete = $_GET['delete'];
    if(isset($delete)){
      $del_sql = "DELETE FROM login WHERE username='$delete'";
      ...
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          ...
          <ul class="nav navbar-nav navbar-right">
            <li><a href="#">Welcome, <?php echo $user_check ?></a></li>
          ...
          <div class="col-md-9">
            ...
            <div class="panel panel-default">
              ...
              <div class="panel-body">
                ...
                <div class="col-md-3">
                  <div class="well dash-box">
                    <h2><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span> <?php echo count($arr); ?></h2>
                    <h4>Posts</h4>
                  </div>
                </div>
                <div class="col-md-3">
                  ...
                  <table class="table table-striped table-hover">
                      ...
                      <?php
                        ...
                        for($i = 0; $i < count($users); $i++){
                          ...
                          echo "<td>{$username}</td>";
                          if($i > 0){
                            echo "<td><a class='btn btn-danger' href='dashboard.php?delete={$username}'>Delete</a></td>";
                          }else{
                            echo "<td></td>";
                          }
                          echo "</tr>";
