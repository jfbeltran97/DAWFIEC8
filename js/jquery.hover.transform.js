...
$(document).ready(function () {
    ...
    $('div.product').hoverTransform({
        selfTransition: false,
        childTriggerElements: 'img', //child elements that (hover) trigger transforms
        childTransitionElements: 'img' //child elements that transform
    });
