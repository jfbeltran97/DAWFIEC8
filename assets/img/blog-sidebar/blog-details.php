<?php 
    ...
    if(isset($_POST['submit'])){
        $name = $_POST['comment-author-name'];
        $comment = $_POST['comment-message'];
        Comentario::saveCommentDatabase($id, $comment, $name);
    }

    if(isset($id)){
        $new = Noticia::getNew($id);
        $comments = Comentario::loadComments($id);
    }else{
                    ...
                    <div class="col-lg-8 col-md-10 d-none d-lg-block text-right">
                        <nav class="main-menu">
                            <ul>
                                ...
                                <li class="active">
                                    <a href="blog-details.html">Noticias</a>
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <ul class="breadcrumb-nav list-inline">
                        <li><a href="blog-left-sidebar.html">Noticias</a></li>
                    ...
                    <article class="blog-post">
                        ...
                        <div class="post-content">
                            <?php 
                                ...
                                echo "<h3 class='post-title pb-3'>{$title}</h3>{$description}"
                             ?>
                        <!-- AddToAny BEGIN -->
                                    ...
                                    for ($i=0; $i < count($comments); $i++) { 
                                        ...
                                        echo "<li class='media'>
                                                ...
                                                <div class='media-body'>
                                                    <h5 class='comment-author'><a href='#'>{$author}</a></h5>
                                                    <p class='comment-time-left'></p>
                ...
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <aside class="widget widget_contact">
                        ...
                        <ul>
                            ...
                            <li><i class="fas fa-phone"></i>0997829038 - 0999402636</li>
